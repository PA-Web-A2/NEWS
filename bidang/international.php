<?php
      ...
      $result = mysqli_query($conn,"SELECT*FROM berita WHERE Jenis='international'");
  ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<h1 style="text-align:center; padding: 13% 0 5% 0; font-weight:bold;">Berita International</h1>
